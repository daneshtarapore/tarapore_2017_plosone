...
void CEPuckForaging::ControlStep()
{
    ...
    else if(m_sStateData.State == SStateData::STATE_EXPLORING)
    {
        ...
        CDisperseBehavior* pcDisperseBehavior = new CDisperseBehavior(0.1f, CRange<CDegrees>(CDegrees(-10.0f), CDegrees(10.0f)));
        m_vecBehaviors.push_back(pcDisperseBehavior);

        CRandomWalkBehavior* pcRandomWalkBehavior = new CRandomWalkBehavior(0.05);
    ...
    else if(m_sStateData.State == SStateData::STATE_RETURN_TO_NEST) // Perform exploration
    {
        ...
        CPhototaxisBehavior* pCPhototaxisBehavior = new CPhototaxisBehavior(0.f, CRange<CDegrees>(CDegrees(-20.0f), CDegrees(20.0f)));
